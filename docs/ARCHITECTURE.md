...
### PMM, VMM e scheduler
- `kernel/pmm.c`: bitmap de frames de 4KiB com init a partir do mapa de memória Multiboot2.
- `kernel/vmm.c`: paginação com mapeamento identidade inicial no bootstrap.
